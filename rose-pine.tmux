...
main() {
    ...
    local custom_window_sep_current="#[fg=#ebbcba,bg=default]#I$window_separator#W"
    ...
    local show_session
    readonly show_session="#[fg=#191724,bg=#{?client_prefix,$thm_love,#ebbcba},bold] $current_session_icon #S #[fg=#{?client_prefix,$thm_love,#ebbcba},bg=default]$RIGHT_ENDER "
